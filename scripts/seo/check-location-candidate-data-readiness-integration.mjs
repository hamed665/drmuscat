...
const allowedReferenceFiles = new Set([
  'src/config/geo/location-candidate-data-readiness-contract.ts',
  'src/lib/geo/oman-location-candidate-data-readiness.ts',
  'src/lib/geo/oman-location-candidate-data-readiness.test.ts',
...
const forbiddenUsageTokens = [
  'location-candidate-data-readiness-contract',
  'oman-location-candidate-data-readiness',
...
function requireTokens(label, source, tokens) {
  ...
  if (missing.length > 0) {
    console.error(`${label} is missing required data-readiness integration guard tokens:`);
...
if (violations.length > 0) {
  console.error('Candidate data-readiness runtime must not be integrated into routes, sitemap, registry, UI, database, or public surfaces yet.');
...
requireTokens('package.json', packageJson, [
  'seo:location-candidate-data-readiness-integration:validate',
  'check-location-candidate-data-readiness-integration.mjs',
]);

console.log('Location candidate data-readiness integration guard passed.');
