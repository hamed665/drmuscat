...
const copyByLocale: Record<SupportedLocale, RouteCopy> = {
  en: {
    title: 'Clinics and Medical Centers in Oman',
    description: 'Center discovery pages are being prepared for structured provider data.',
    badge: 'Public discovery route',
    panelHeading: 'Provider data preparation in progress',
    panelBody: 'Center discovery pages are being prepared for structured provider data.',
  ...
  ar: {
    title: 'العيادات والمراكز الطبية في عُمان',
    description: 'يتم تجهيز صفحات اكتشاف العيادات والمراكز لعرض بيانات مقدمي الخدمة المنظمة في مراحل قادمة.',
    badge: 'مسار استكشاف عام',
    panelHeading: 'جاري تجهيز بيانات مقدمي الخدمة',
    panelBody: 'يتم تجهيز صفحات اكتشاف العيادات والمراكز لعرض بيانات مقدمي الخدمة المنظمة.',
