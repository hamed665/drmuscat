...
const copyByLocale: Record<SupportedLocale, RouteCopy> = {
  en: {
    title: 'Doctors in Oman',
    description: 'Doctor discovery pages are being prepared for structured provider data.',
    badge: 'Public discovery route',
    panelHeading: 'Provider data preparation in progress',
    panelBody: 'Doctor discovery pages are being prepared for structured provider data.',
  ...
  ar: {
    title: 'الأطباء في عُمان',
    description: 'يتم تجهيز صفحات اكتشاف الأطباء لعرض بيانات مقدمي الخدمة المنظمة في مراحل قادمة.',
    badge: 'مسار استكشاف عام',
    panelHeading: 'جاري تجهيز بيانات مقدمي الخدمة',
    panelBody: 'يتم تجهيز صفحات اكتشاف الأطباء لعرض بيانات مقدمي الخدمة المنظمة.',
