...
const copyByLocale: Record<SupportedLocale, RouteCopy> = {
  en: {
    title: 'Healthcare Services in Oman',
    description: 'Service discovery pages are being prepared for structured provider data.',
    badge: 'Public discovery route',
    panelHeading: 'Provider data preparation in progress',
    panelBody: 'Service discovery pages are being prepared for structured provider data.',
  ...
  ar: {
    title: 'الخدمات الصحية في عُمان',
    description: 'يتم تجهيز صفحات اكتشاف الخدمات الصحية لعرض بيانات مقدمي الخدمة المنظمة في مراحل قادمة.',
    badge: 'مسار استكشاف عام',
    panelHeading: 'جاري تجهيز بيانات مقدمي الخدمة',
    panelBody: 'يتم تجهيز صفحات اكتشاف الخدمات الصحية لعرض بيانات مقدمي الخدمة المنظمة.',
